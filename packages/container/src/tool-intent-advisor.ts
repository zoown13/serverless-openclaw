...
function promptFor(input: DecideToolIntentInput): string {
  return [
    ...
    "Choose clarify_source for ambiguous payment or personal-data questions when the user did not explicitly name a source.",
    "Choose continue_active_task when the message is a follow-up to the active task context.",
